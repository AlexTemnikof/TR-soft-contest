...
public class UserController {
    ...
    public UserDTO updateSurname(@PathVariable("id") String id, @RequestParam String surname){
        return service.updateSurnameById(id, surname);
    }

    @PatchMapping("/{id}/name")
    public UserDTO updateName(@PathVariable("id") String id, @RequestParam String name){
        return service.updateNameById(id, name);
    }

    @PatchMapping("/{id}/patronymic")
    public UserDTO updatePatronymic(@PathVariable("id") String id, @RequestParam String patronymic){
